...
def hello_world():
    img_path = 'runs\\detect\\exp3\\' + str(filename)
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str,default=r'D:\yolo-workimport torch\yolov5-master\runs\train\exp6\weights\best.pt',help='model path or triton URL')
    parser.add_argument('--source', type=str, default=file_path, help='file/dir/URL/glob/screen/0(webcam)')
    parser.add_argument('--data', type=str, default=r'D:\yolo-workimport torch\yolov5-master\data\mydata.yaml',help='(optional) dataset.yaml path')
